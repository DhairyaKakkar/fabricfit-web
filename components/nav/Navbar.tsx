    ...
    <>
      ...
      <div style={{
        ...
        <header style={{
          ...
          <div style={{
            height: showPill ? 72 : 88,
            display: 'flex', alignItems: 'center',
            padding: showPill ? '0 28px' : '0 48px',
            ...
            <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none', flexShrink: 0 }}>
              <Image
                ...
                style={{ height: showPill ? 38 : 46, width: 'auto', display: 'block', transition: 'height 0.35s cubic-bezier(0.4,0,0.2,1)' }}
              />
              <span style={{
                fontFamily: 'var(--font-playfair)', fontSize: showPill ? 19 : 22, fontWeight: 700,
