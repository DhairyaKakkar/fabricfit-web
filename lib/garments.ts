...
export const GARMENTS: Garment[] = [
  // Male (5)
  {
    ...
    label: 'Shirt',
    gender: 'male',
    floatSrc: '/garments/shirt.png',
    compositeSrc: '/models/male-shirt.png',
  ...
  },
  {
    ...
    label: 'Kurta',
    gender: 'male',
    floatSrc: '/garments/kurta.png',
    compositeSrc: '/models/male-kurta.png',
  ...
  },
  {
    ...
    label: 'Sherwani',
    gender: 'male',
    floatSrc: '/garments/sherwani.png',
    compositeSrc: '/models/male-sherwani.png',
  ...
  },
  {
    ...
    label: 'Nehru Coat',
    gender: 'male',
    floatSrc: '/garments/nehru-coat.png',
    compositeSrc: '/models/male-nehru-coat.png',
  ...
  },
  {
    ...
    label: 'Blazer',
    gender: 'male',
    floatSrc: '/garments/blazer.png',
    compositeSrc: '/models/male-blazer.png',
  ...
  // Female (5)
  {
    ...
    label: 'Casual Dress',
    gender: 'female',
    floatSrc: '/garments/casual-dress.png',
    compositeSrc: '/models/female-casual-dress.png',
  ...
  },
  {
    ...
    label: 'Jumpsuit',
    gender: 'female',
    floatSrc: '/garments/jumpsuit.png',
    compositeSrc: '/models/female-jumpsuit.png',
  ...
  },
  {
    ...
    label: 'Anarkali',
    gender: 'female',
    floatSrc: '/garments/anarkali.png',
    compositeSrc: '/models/female-anarkali.png',
  ...
  },
  {
    ...
    label: 'Saree',
    gender: 'female',
    floatSrc: '/garments/saree.png',
    compositeSrc: '/models/female-saree.png',
  ...
  },
  {
    ...
    label: 'Lehenga',
    gender: 'female',
    floatSrc: '/garments/lehenga.png',
    compositeSrc: '/models/female-lehenga.png',
...
export const BASE_MODELS: Record<Gender, string> = {
  male: '/models/male-base.png',
  female: '/models/female-base.png',
};
